...
public class WebController {
    ...
    public String adminUsers(Model model, Principal principal, @RequestParam(name = "msg", required = false) String msg) {
    ...
    public String adminSaveUser(@PathVariable long id, @RequestParam("name") String name,
            @RequestParam("lastName") String lastName, @RequestParam("dateOfBirth") LocalDate dateOfBirth,
            ...
            @RequestParam("imageFile") MultipartFile file, Principal principal, Model model)
        ...
        // --- PARCHE XSS: Limpiamos los campos de texto del usuario ---
        // Usamos Safelist.none() porque un nombre/email no debe contener ninguna etiqueta HTML
        user.setName(Jsoup.clean(name, Safelist.none()));
        user.setLastName(Jsoup.clean(lastName, Safelist.none()));
        user.setEmail(Jsoup.clean(email, Safelist.none()));
        user.setUsername(Jsoup.clean(username, Safelist.none()));
        // -------------------------------------------------------------
