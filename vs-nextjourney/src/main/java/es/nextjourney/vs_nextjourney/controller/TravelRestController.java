...
public class TravelRestController { 
    ...
    public ResponseEntity<TravelDTO> updateTravel(@PathVariable Long id, @RequestBody TravelDTO travelDTO, Principal principal, Authentication authentication) { 
        ...
        // XSS protection - sanitize the data from the DTO before saving
        sanitizeTravelData(updatedTravel);
    ...
    public ResponseEntity<ImageDTO> createTravelImage(@PathVariable long id, @RequestParam("imageFile") MultipartFile imageFile, Principal principal, Authentication authentication) throws IOException { 
    ...
    public ResponseEntity<ImageDTO> createTravelCoverImage(@PathVariable long id, @RequestParam("coverImageFile") MultipartFile imageFile, Principal principal, Authentication authentication) throws IOException { 
        // check if user is logged in 
        if (principal == null) { 
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).build(); 
        } 
    ...
    public ResponseEntity<Void> deleteTravelCoverImage(@PathVariable long id, Principal principal, Authentication authentication) { 
        // check if user is logged in 
        if (principal == null) { 
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).build(); 
        } 
    ...
    public ResponseEntity<TravelDTO> uploadTravelItinerary(@PathVariable long id, @RequestParam("itineraryFile") MultipartFile itineraryFile, Principal principal, Authentication authentication) throws IOException { 
    ...
    public ResponseEntity<Void> deleteTravelItinerary(@PathVariable long id, Principal principal, Authentication authentication) { 
        // verify the user is authenticated 
        if (principal == null) { 
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).build(); 
        } 
    ...
    public ResponseEntity<Void> deleteTravelImage(@PathVariable long id, @PathVariable long imageId, Principal principal, Authentication authentication) throws IOException { 
        // check if user is logged in 
        if (principal == null) { 
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).build(); 
        } 
